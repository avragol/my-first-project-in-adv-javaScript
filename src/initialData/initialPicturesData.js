...
const createPicData = () => {
    return [
        ...
        new Picture("https://cdn.pixabay.com/photo/2015/05/21/00/08/wailing-wall-776366_1280.jpg", "The Majesty of Nature", 3000, "Aleks from Pixabay", "Western Wall, Jerusalem, Israel")
    ]
}
